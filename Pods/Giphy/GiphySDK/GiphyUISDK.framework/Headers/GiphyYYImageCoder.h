...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, GiphyYYImageType) {
    GiphyYYImageTypeUnknown = 0, ///< unknown
    GiphyYYImageTypeJPEG,        ///< jpeg, jpg
    GiphyYYImageTypeJPEG2000,    ///< jp2
    GiphyYYImageTypeTIFF,        ///< tiff, tif
    GiphyYYImageTypeBMP,         ///< bmp
    GiphyYYImageTypeICO,         ///< ico
    GiphyYYImageTypeICNS,        ///< icns
    GiphyYYImageTypeGIF,         ///< gif
    GiphyYYImageTypePNG,         ///< png
    GiphyYYImageTypeWebP,        ///< webp
    GiphyYYImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, GiphyYYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    GiphyYYImageBlendNone = 0,
    
    /**
     The frame should be composited onto the output buffer based on its alpha.
     */
    GiphyYYImageBlendOver,
};

/**
 An image frame object.
 */
@interface GiphyYYImageFrame : NSObject <NSCopying>
...
@property (nonatomic) GiphyYYImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) GiphyYYImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    GiphyYYImageDecoder *decoder = [GiphyYYImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    GiphyYYImageDecoder *decoder = [[GiphyYYImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface GiphyYYImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) GiphyYYImageType type;          ///< Image data type.
 ...
 */
- (nullable GiphyYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in GiphyYYImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    GiphyYYImageEncoder *jpegEncoder = [[GiphyYYImageEncoder alloc] initWithType:GiphyYYImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    GiphyYYImageEncoder *gifEncoder = [[GiphyYYImageEncoder alloc] initWithType:GiphyYYImageTypeGIF];
 ...
 */
@interface GiphyYYImageEncoder : NSObject

@property (nonatomic, readonly) GiphyYYImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(GiphyYYImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(GiphyYYImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(GiphyYYImageDecoder *)decoder type:(GiphyYYImageType)type quality:(CGFloat)quality;
...
@interface UIImage (GiphyYYImageCoder)
...
CG_EXTERN GiphyYYImageType GiphyYYImageDetectType(CFDataRef data);

/// Convert GiphyYYImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable GiphyYYImageTypeToUTType(GiphyYYImageType type);

/// Convert UTI (such as kUTTypeJPEG) to GiphyYYImageType.
CG_EXTERN GiphyYYImageType GiphyYYImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable GiphyYYImageTypeGetExtension(GiphyYYImageType type);
...
CG_EXTERN BOOL GiphyYYCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation GiphyYYUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger GiphyYYUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable GiphyYYCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable GiphyYYCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable GiphyYYCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable GiphyYYCGImageCreateEncodedData(CGImageRef imageRef, GiphyYYImageType type, CGFloat quality);
 ...
 */
CG_EXTERN NSUInteger GiphyYYImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable GiphyYYCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, GiphyYYImagePreset) {
    GiphyYYImagePresetDefault = 0,  ///< default preset.
    GiphyYYImagePresetPicture,      ///< digital picture, like portrait, inner shot
    GiphyYYImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    GiphyYYImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    GiphyYYImagePresetIcon,         ///< small-sized colorful images
    GiphyYYImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is GiphyYYImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable GiphyYYCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             GiphyYYImagePreset preset);
